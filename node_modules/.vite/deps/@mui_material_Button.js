...
function mergeSlotProps(parameters) {
  ...
  if (!getSlotProps) {
    const joinedClasses2 = clsx_m_default2(externalForwardedProps == null ? void 0 : externalForwardedProps.className, externalSlotProps == null ? void 0 : externalSlotProps.className, className, additionalProps == null ? void 0 : additionalProps.className);
  ...
  const joinedClasses = clsx_m_default2(internalSlotProps == null ? void 0 : internalSlotProps.className, additionalProps == null ? void 0 : additionalProps.className, className, externalForwardedProps == null ? void 0 : externalForwardedProps.className, externalSlotProps == null ? void 0 : externalSlotProps.className);
    ...
    children: [(0, import_jsx_runtime25.jsx)(Rail, _extends({}, railProps)), (0, import_jsx_runtime25.jsx)(Track, _extends({}, trackProps)), marks.filter((mark) => mark.value >= min2 && mark.value <= max2).map((mark, index) => {
      ...
      return (0, import_jsx_runtime26.jsxs)(React47.Fragment, {
        children: [(0, import_jsx_runtime25.jsx)(Mark, _extends({
          ...
          className: clsx_m_default2(markProps.className, markActive && classes.markActive)
          ...
          className: clsx_m_default2(classes.markLabel, markLabelProps.className, markActive && classes.markLabelActive),
          children: mark.label
        })) : null]
      }, index);
      ...
      return (0, import_jsx_runtime26.jsxs)(Thumb, _extends({
        ...
        className: clsx_m_default2(classes.thumb, thumbProps.className, active === index && classes.active, focusedThumbIndex === index && classes.focusVisible),
...
function createBox(options = {}) {
  ...
  const Box2 = React75.forwardRef(function Box3(inProps, ref) {
    ...
    return (0, import_jsx_runtime45.jsx)(BoxRoot, _extends({
      as: component,
      ref,
      className: clsx_m_default3(className, generateClassName ? generateClassName(defaultClassName) : defaultClassName),
  ...
  const Container2 = React83.forwardRef(function Container3(inProps, ref) {
    ...
    return (
      ...
      (0, import_jsx_runtime51.jsx)(ContainerRoot, _extends({
        as: component,
        ownerState,
        className: clsx_m_default3(classes.root, className),
        ref
      }, other))
    );
  });
...
var TouchRipple = React93.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const startTimer = React93.useRef(null);
...
export {
  buttonClasses_default2 as buttonClasses,
